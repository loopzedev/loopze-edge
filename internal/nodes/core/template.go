...
func (n *TemplateNode) Init() error {
	...
	n.template = nodes.StringVal(props, "template", "")
	n.field = nodes.StringVal(props, "field", "payload")
	n.fieldType = nodes.StringVal(props, "fieldType", "msg")
	n.fieldStorage = nodes.StringVal(props, "fieldStorage", "memory")
	n.format = nodes.StringVal(props, "format", "plain")
	n.syntax = nodes.StringVal(props, "syntax", "mustache")
...
func (n *TemplateNode) writeOutput(msg *flow.Message, value any) error {
	...
	case "msg":
		...
		return nil
	case "flow", "global":
		store := nodes.PickContextStore(n.valueContext(), n.fieldType, n.fieldStorage)
		if store == nil {
			return nil
		}
...
func (n *TemplateNode) valueContext() nodes.ValueContext {
