...
func (n *UDPOutNode) Init() error {
	...
	n.bindHost = strings.TrimSpace(nodes.StringVal(props, "bindHost", ""))
	n.mode = strings.ToLower(nodes.StringVal(props, "mode", udpOutModeUnicast))
	switch n.mode {
	...
	n.multicastTTL = nodes.IntVal(props, "multicastTTL", defaultUdpMulticastTTL)
